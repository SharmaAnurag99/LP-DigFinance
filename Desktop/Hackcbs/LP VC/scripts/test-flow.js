...
async function main() {
  ...
  console.log("\n🖥️  Dashboard Cue:");
  console.log("  After running this script, open the frontend and:");
  console.log("   • Connect as VC (Account 1) to review the VC Manager tab logs.");
  console.log("   • Switch to LP wallets to check the LP timeline and claimable share.");
  console.log("   • Connect as the startup to show received capital in the Startup tab.");
}
